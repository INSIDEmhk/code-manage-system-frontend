...
<template>
	<view class="teacher-page">
		...
		<view class="backup-schedule">
			<text class="backup-schedule-text">教师账号由管理员统一分发<br></text>
		...
		<view class="info-container">
			<view class="info-item">
				<text class="info-label">教师姓名：</text>
				<input class="info-input" type="text"   v-if="teacherInf"   :value="teacherInf.name" disabled  />
			</view>
			<view class="info-item">
				<text class="info-label">教师账号：</text>
				<input class="info-input" type="text" v-if="teacherInf"  :value="teacherInf.teacherId" disabled />
			</view>
			<view class="info-item">
				<text class="info-label">教师邮箱：</text>
				<input class="info-input" type="text" v-if="teacherInf"  :value="teacherInf.email" disabled />
			</view>
		</view>
		...
		<view v-if="showModifyPasswordModal" class="modify-password-modal">
		    <view class="modal-content1">
				...
				<text class="info-label">输入当前教师账号：</text>
...
export default {
	...
	methods: {
		...
		// goToHome() {
		// 	uni.redirectTo({
		// 		url: `/pages/index/teacher/teacher1?id=${this.who}`  // 添加 id 参数
		// 	});
		...
		goToHome() {
			if(this.who){
				...
				uni.reLaunch({
					url: "/pages/index/teacher/teacher1"
				});
			}
